## Marc Tagne Assignment 1, plot1.R : EDA COURSERA
##
...
#hist
##plot1
plot1 <- function(filename=NULL){
  with(mydata, hist(Global_active_power, col="red", xlab = "Global Active Power(killowatts)", main = "Global Active Power"))
  if(!missing(filename)){
